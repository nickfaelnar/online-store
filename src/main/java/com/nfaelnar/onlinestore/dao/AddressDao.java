...
public class AddressDao extends BaseDao {
	...
	private final String GET_USER_ADDRESS = "SELECT * FROM address WHERE user_id = ? AND address_id = ?";
	...
	public Address getAddress(int userId, int addressId) {
		Address address = (Address) getJdbcTemplate().queryForObject(GET_USER_ADDRESS, new Object[] { userId, addressId },
